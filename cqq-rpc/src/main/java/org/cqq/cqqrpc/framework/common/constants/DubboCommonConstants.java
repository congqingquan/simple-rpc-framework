...
/**
 * Created by QQ.Cong on 2023-04-26 / 16:58
 *
 * @Description Copy from org.apache.dubbo.common.constants.CommonConstants
 */
public interface DubboCommonConstants {
    ...
    String PROTOCOL_SEPARATOR_ENCODED = encode(PROTOCOL_SEPARATOR);
